...
import com.hojadevida.retoHojaDeVida.domian.event.NombreCompletoReferenciaActualizado;
...
class ActualizarNombreCompletoReferenciaUseCaseTest {
    ...
    void actualizrNombreReferencia(){
        //arrange
        var command = new ActualizarNombreCompletoReferencia(PerfilId.of(IDPERFIL),
                new NombreCompleto("Parque Explora"));
        ...
        //assert
        var event = (NombreCompletoReferenciaActualizado) events.get(0);
        Assertions.assertEquals("Parque Explora",event.getNombreCompleto().value());
    ...
    private List<DomainEvent> EventStored() {
        return List.of(
                ...
                new ReferenciaAgregada(new ReferenciaId(IDREFERENCIA),
                        ...
                        new NombreCompleto("Universidad de la vida"))
        );
    }
